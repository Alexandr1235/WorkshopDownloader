...
MyGui := Gui(, "MiniGuiWorkshopDownloader")
...
MyGui.Add("edit", "w350 r1 vUrl")
MyGui.Add("Button", "Default y+5", "SteamApi ").OnEvent("Click", start_SteamApi)
MyGui.Add("Button", "Default x+5", "ABCVG ").OnEvent("Click", start_ABCVG)
MyGui.Add("Button", "Default x+5", "GGNTW").OnEvent("Click", start_ggntw)
MyGui.Add("Button", "Default x+5", "SteamCmd").OnEvent("Click", start1)
MyGui.Add("Button", "Default x+5", "About").OnEvent("Click", start3)
MyGui.Show()
Return
